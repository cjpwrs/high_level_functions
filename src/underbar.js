(function() {
  ...
  _.uniq = function(array) {
    ...
    _.each(array, function(val) {
      if (_.indexOf(noDuplicates, val)===-1) {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      if (!already[arguments[0]]) {
        already[arguments[0]] = func.apply(this, arguments);
      }
      return already[arguments[0]];
    }
  };
  ...
  _.shuffle = function(array) {
    ...
    for (last = array2.length - 1; last >= 0; last--) {
      temp = array2[last];
      rand = Math.floor(Math.random() * (last));
      array2[last] = array2[rand];
      array2[rand] = temp;
      shuffledArray.push(array2.pop());
    }
